        ...
        return `
            <main class="sign-container">
                <form class="sign__form">
                    ...
                    {{{InputControl inputName="second_name" label="Second name" inputValue="${values.second_name}" error="${errors.second_name}"
                    ...
                    {{{InputControl inputName="email" label="E-mail" inputValue="${values.email}" error="${errors.email}"
                                    id="email" type="email" onBlur=onBlur onFocus=onFocus}}}
                    {{{InputControl inputName="phone" label="Phone" inputValue="${values.phone}" error="${errors.phone}"
                                    id="phone" type="number" onBlur=onBlur onFocus=onFocus}}}
                    {{{InputControl inputName="password" label="Password" inputValue="${values.password}" error="${errors.password}"
